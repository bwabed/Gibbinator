                ...
                $(document).ready(function () {
                    $('#delete_button').click(function (e) {
                        ...
                        if (selectedUsers.length != 0) {
                            $.post("/admin/edit_klasse", {delete_users: selectedUsers, klassen_id: <?= htmlentities($klasse->id) ?>})
                                .done(function (data) {
                                    'use strict';
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function () {
                    $('#add_button').click(function (e) {
                        ...
                        if (selectedUsers.length != 0) {
                            $.post("/admin/edit_klasse", {add_users: selectedUsers, klassen_id: <?= htmlentities($klasse->id) ?>})
                                .done(function (data) {
                                    'use strict';
                                    var snackbarContainer = document.querySelector('#snackbar');
