<div class="mdl-grid mdl-layout__content">
        ...
        <form action="/admin/add_building" method="post">
            <div class="mdl-card__supporting-text">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="build_name" name="build_name" value="<?= isset($_POST['build_name']) ? htmlentities($_POST['build_name']) : "" ?>">
                    <label class="mdl-textfield__label" for="build_name">Bezeichnung*</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="build_street" name="build_street" value="<?= isset($_POST['build_street']) ? htmlentities($_POST['build_street']) : "" ?>">
                    <label class="mdl-textfield__label" for="build_street">Strasse*</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="number" id="build_number" name="build_number" value="<?= isset($_POST['build_number']) ? htmlentities($_POST['build_number']) : "" ?>">
                    <label class="mdl-textfield__label" for="build_number">Nummer*</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="number" id="build_plz" name="build_plz" value="<?= isset($_POST['build_plz']) ? htmlentities($_POST['build_plz']) : "" ?>">
                    <label class="mdl-textfield__label" for="build_plz">PLZ*</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="build_ort" name="build_ort" value="<?= isset($_POST['build_ort']) ? htmlentities($_POST['build_ort']) : "" ?>">
    ...
    <div class="mdl-card mdl-cell mdl-card-form mdl-cell--4-col mdl-shadow--2dp">
        ...
        <form action="/admin/add_floor" method="post">
            <div class="mdl-card__supporting-text">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="floor_name" name="floor_name" value="<?= isset($_POST['floor_name']) ? htmlentities($_POST['floor_name']) : "" ?>">
                    <label class="mdl-textfield__label" for="floor_name">Bezeichnung*</label>
                </div>
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="floor_number" name="floor_number" value="<?= isset($_POST['floor_number']) ? htmlentities($_POST['floor_number']) : "" ?>">
    ...
    <div class="mdl-cell mdl-card mdl-cell--4-col mdl-shadow--2dp">
        ...
        <form action="/admin/add_room" method="post">
            <div class="mdl-card__supporting-text">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="text" id="room_name" name="room_name" value="<?= isset($_POST['room_name']) ? htmlentities($_POST['room_name']) : "" ?>">
    ...
    <div class="mdl-card mdl-cell mdl-cell--7-col mdl-grid--no-spacing mdl-shadow--2dp">
        <div class="mdl-cell--12-col mdl-card__title mdl-color--indigo-500">
