        ...
        <div class="mdl-card__supporting-text">
            <form action="/admin/check_edit_user" method="post">
                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    <input class="mdl-textfield__input" type="email" id="new_username" name="new_username" value="<?= isset($_POST['new_username']) ? htmlspecialchars(strip_tags($_POST['new_username'])) : $userData->email; ?>">
